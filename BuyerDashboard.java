...
public class BuyerDashboard extends JFrame {
    ...
    private void buildUI() {
        ...
        tabs.addTab("🍿  Browse Snacks", new BrowseSnacksPanel(custId));
        tabs.addTab("📦  My Orders",     new MyOrdersPanel(custId));
    ...
    private JPanel buyerCard(String label, String val, Color c) {
        ...
        GridBagConstraints g=new GridBagConstraints();g.gridx=0;g.gridy=0;g.anchor=GridBagConstraints.WEST;
        JLabel l=new JLabel(label);l.setFont(UIConstants.LABEL_FONT);l.setForeground(UIConstants.MUTED);
        JLabel v=new JLabel(val);v.setFont(new Font("Segoe UI",Font.BOLD,30));v.setForeground(c);
